...
> Playbook: `docs/agents/playbooks/new-blazor-page.md`. Blazor patterns: [core/blazor-patterns.md](../core/blazor-patterns.md). Audit fields: [reference/audit-fields.md](../reference/audit-fields.md).

You are creating a **complete new page** for PetelATH or PetelAssistants. Adjust namespaces, schema, and audit column names for the target app. Gather all requirements, then generate every artifact.
...
Use the canonical template from `docs/agents/core/blazor-patterns.md`:
- `@page "/{pagename}"`
- `@layout MainLayout`
