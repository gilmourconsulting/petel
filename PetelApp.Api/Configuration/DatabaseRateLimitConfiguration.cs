...
namespace PetelApp.Api.Configuration
{
    ...
    public class DatabaseRateLimitConfigurationService
    {
        ...
        private PetelApp.Api.Services.RateLimitConfig? _cachedConfig;
        ...
        /// </summary>
        public async Task<PetelApp.Api.Services.RateLimitConfig> GetCurrentConfigAsync()
        {
            return await GetRateLimitConfigAsync();
        }

        private async Task<PetelApp.Api.Services.RateLimitConfig> GetRateLimitConfigAsync()
        {
            ...
            catch (Exception ex)
            {
                ...
                return new PetelApp.Api.Services.RateLimitConfig
                {
